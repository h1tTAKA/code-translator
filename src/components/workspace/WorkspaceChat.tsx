          ...
          <div className="flex flex-col gap-3">
            {messages.map((m, i) => {
              ...
              return (
                <div key={i} className="flex max-w-full flex-col items-start gap-1.5 text-[12px] leading-relaxed text-zinc-700 dark:text-zinc-200">
                  <div className="max-w-full"><Markdown className="nunopi-md-lg">{text}</Markdown></div>
                  {cards.length > 0 && (
            ...
            {streaming != null && (
              <div className="max-w-full text-[12px] leading-relaxed text-zinc-700 dark:text-zinc-200">
                {streaming
                  ? <div className="max-w-full"><Markdown className="nunopi-md-lg">{stripStreamingCardBlock(streaming)}</Markdown></div>
