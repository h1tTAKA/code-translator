...
import { IconFolderOpen, IconFiles, IconTerminal2, IconFileCode, IconMessageCircle } from "@tabler/icons-react";
  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-col">
      ...
      <div className="flex min-h-0 flex-1">
        {/* 좌: 파일트리 */}
        <aside className="w-60 shrink-0 border-r border-zinc-200 dark:border-zinc-800"><ZonePlaceholder Icon={IconFiles} label={t("workspace.tree")} /></aside>
        {/* 가운데: 터미널 | 코드 (가로분할) */}
        <section className="flex min-w-0 flex-1">
          <div className="min-w-0 flex-1 border-r border-zinc-200 dark:border-zinc-800"><ZonePlaceholder Icon={IconTerminal2} label={t("workspace.terminal")} /></div>
          <div className="min-w-0 flex-1"><ZonePlaceholder Icon={IconFileCode} label={t("workspace.code")} /></div>
        </section>
        {/* 우: 챗룸 */}
